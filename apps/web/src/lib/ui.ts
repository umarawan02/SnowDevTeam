...
export const ARTIFACT_META: Record<ArtifactType, { label: string; role: AgentRole }> = {
  ...
  BUILD_LOG: { label: "Build", role: "DEVELOPER" },
  CHANGE_PLAN: { label: "Change Plan", role: "DEVELOPER" },
  CHANGE_PLAN_DIFF: { label: "Change Plan Diff", role: "DEVELOPER" },
  TEST_PLAN: { label: "Test Plan", role: "QA" },
  QA_REPORT: { label: "QA Report", role: "QA" },
  DELIVERY_SUMMARY: { label: "Delivered", role: "QA" },
